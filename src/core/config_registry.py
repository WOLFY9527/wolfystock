...
_CATEGORY_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": "Optional DuckDB factor store and quant benchmark settings.",
        "display_order": 65,
    },
    {
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "AI_PRIMARY_GATEWAY": {
        "title": "AI Primary Gateway",
        "description": "Admin-selected primary AI gateway/provider route (e.g. aihubmix, gemini, openai).",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "AI_PRIMARY_MODEL": {
        "title": "AI Primary Model",
        "description": "Admin-selected primary model under the primary gateway.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "AI_BACKUP_GATEWAY": {
        "title": "AI Backup Gateway",
        "description": "Admin-selected backup gateway/provider route.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "AI_BACKUP_MODEL": {
        "title": "AI Backup Model",
        "description": "Admin-selected backup model under the backup gateway.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "FRED_API_KEY": {
        "title": "FRED API Key",
        "description": "Optional API key for FRED macro series requests. Leave empty to use the public no-key path when available.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "ALPACA_API_KEY_ID": {
        ...
        "description": "Key ID for Alpaca market-data access. Must be paired with ALPACA_API_SECRET_KEY.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "ALPACA_API_SECRET_KEY": {
        ...
        "description": "Secret key paired with ALPACA_API_KEY_ID for Alpaca market-data access.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "ALPACA_DATA_FEED": {
        "title": "Alpaca Data Feed",
        "description": "US market-data feed hint for Alpaca snapshots/bars. Use iex by default; sip requires the appropriate Alpaca data entitlement.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "default_value": "iex",
        "options": ["iex", "sip"],
        "validation": {"enum": ["iex", "sip"]},
        "display_order": 18,
    },
    "TWELVE_DATA_API_KEY": {
        "title": "Twelve Data API Key",
        "description": "Single Twelve Data API key for market-data history and quote requests.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "TWELVE_DATA_API_KEYS": {
        "title": "Twelve Data API Keys (Multi)",
        "description": "Comma-separated Twelve Data API keys. Takes priority over TWELVE_DATA_API_KEY.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "FINNHUB_API_KEY": {
        ...
        "description": "Single Finnhub API key for US quote, metrics, and news fallbacks.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "FINNHUB_API_KEYS": {
        "title": "Finnhub API Keys (Multi)",
        "description": "Comma-separated Finnhub API keys. Takes priority over FINNHUB_API_KEY.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "FMP_API_KEY": {
        "title": "FMP API Key",
        "description": "Single Financial Modeling Prep API key for US fundamentals and historical data fallbacks.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "FMP_API_KEYS": {
        "title": "FMP API Keys (Multi)",
        "description": "Comma-separated Financial Modeling Prep API keys. Takes priority over FMP_API_KEY.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "ALPHA_VANTAGE_API_KEY": {
        ...
        "description": "Single Alpha Vantage API key. Current runtime reads only ALPHA_VANTAGE_API_KEY; multi-key aliases remain diagnostics-only.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "SCANNER_PROFILE": {
        ...
        "description": "Default Market Scanner profile key.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "cn_preopen_v1",
        "options": [],
        "validation": {},
        "display_order": 12,
    },
    "SCANNER_LOCAL_UNIVERSE_PATH": {
        "title": "Scanner Local Universe Path",
        "description": "Local cache path for the A-share scanner universe CSV file.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "./data/scanner_cn_universe_cache.csv",
        "options": [],
        "validation": {},
        "display_order": 13,
    },
    "LOCAL_US_QUOTE_SNAPSHOT_CACHE_PATH": {
        "title": "Local US Quote Snapshot Cache Path",
        "description": "Read-only local JSON cache path for US quote snapshot evidence.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "SCANNER_SCHEDULE_ENABLED": {
        "title": "Scanner Schedule Enabled",
        "description": "Enable the dedicated pre-open Market Scanner schedule.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "SCANNER_SCHEDULE_TIME": {
        "title": "Scanner Schedule Time",
        "description": "Daily pre-open scanner time in HH:MM format.",
        "category": "system",
        "data_type": "time",
        "ui_control": "time",
        "is_sensitive": False,
    ...
    "SCANNER_SCHEDULE_RUN_IMMEDIATELY": {
        "title": "Scanner Schedule Run Immediately",
        "description": "Whether to run one scanner job immediately on startup in scanner schedule mode.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "SCANNER_NOTIFICATION_ENABLED": {
        "title": "Scanner Notification Enabled",
        "description": "Whether scheduled Market Scanner runs should push watchlist notifications.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "WATCHLIST_SCORE_REFRESH_ENABLED": {
        "title": "Watchlist Score Refresh Enabled",
        "description": "Enable lightweight pre-open refresh for user watchlist candidate scores.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "WATCHLIST_SCORE_REFRESH_US_TIME": {
        "title": "Watchlist Score Refresh US Time",
        "description": "US watchlist pre-open score refresh time in HH:MM format.",
        "category": "system",
        "data_type": "time",
        "ui_control": "time",
        "is_sensitive": False,
    ...
    "WATCHLIST_SCORE_REFRESH_CN_TIME": {
        "title": "Watchlist Score Refresh CN Time",
        "description": "CN watchlist pre-open score refresh time in HH:MM format.",
        "category": "system",
        "data_type": "time",
        "ui_control": "time",
        "is_sensitive": False,
    ...
    "WATCHLIST_SCORE_REFRESH_HK_TIME": {
        "title": "Watchlist Score Refresh HK Time",
        "description": "HK watchlist pre-open score refresh time in HH:MM format.",
        "category": "system",
        "data_type": "time",
        "ui_control": "time",
        "is_sensitive": False,
    ...
    "WATCHLIST_SCORE_REFRESH_MAX_SYMBOLS": {
        "title": "Watchlist Score Refresh Max Symbols",
        "description": "Maximum user watchlist symbols updated by one scheduled score refresh.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "SHOW_RUNTIME_EXECUTION_SUMMARY": {
        "title": "Show Runtime Execution Summary",
        "description": "Whether to show runtime execution summary cards on homepage. Admin logs center remains available regardless.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "QUANT_ENGINE": {
        "title": "Quant Engine",
        "description": "Primary quant runtime label. Phase 1 keeps python as the normal runtime and DuckDB as an optional accelerator.",
        "category": "quant",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "validation": {"enum": ["python", "duckdb"]},
        "display_order": 10,
    },
    "QUANT_DUCKDB_ENABLED": {
        "title": "Enable DuckDB Quant Engine",
        "description": "Enable explicit DuckDB quant analytics schema and benchmark operations. Disabled by default.",
        "category": "quant",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "DUCKDB_DATABASE_PATH": {
        "title": "DuckDB Database Path",
        "description": "Local DuckDB file used only by explicit quant analytics operations.",
        "category": "quant",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "data/quant/wolfystock.duckdb",
        "options": [],
        "validation": {},
        "display_order": 30,
    },
    "QUANT_PARQUET_ROOT": {
        "title": "Quant Parquet Root",
        "description": "Reserved local root for future quant Parquet research datasets.",
        "category": "quant",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "data/quant/parquet",
        "options": [],
        "validation": {},
        "display_order": 40,
    },
    "QUANT_MAX_BENCHMARK_SYMBOLS": {
        "title": "Max Benchmark Symbols",
        "description": "Upper bound for explicit DuckDB benchmark symbol scans.",
        "category": "quant",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
