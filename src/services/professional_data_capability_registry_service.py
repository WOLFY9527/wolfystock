...
_CAPABILITY_SPECS: tuple[_CapabilitySpec, ...] = (
    ...
    _spec(
        ...
        "Not configured; do not assume current stock-level news, company developments, or catalyst coverage.",
        "News/catalyst readiness registry",
        "Stock news and company catalyst inputs are not configured as a reliable provider-neutral data layer.",
        status="configured_missing",
    ),
    _spec(
        "market.news",
        ...
        "market_breadth_flows",
        "news_catalyst_intelligence",
        "Missing; market overview must not claim current market news or broad catalyst coverage.",
        "News/catalyst readiness registry",
        "Market news requires a verified source contract before it can appear as current event context.",
        status="configured_missing",
    ),
    _spec(
        ...
        "stock_research_data",
        "news_catalyst_intelligence",
        "Missing; existing event helpers are scaffold/sample-bounded, not a verified calendar feed.",
        "News/catalyst readiness registry",
        "Earnings and event calendar readiness is missing until as-of, timezone, source, and no-event states are proven.",
        status="configured_missing",
    ),
    _spec(
        ...
        "macro_cross_asset_regime",
        "news_catalyst_intelligence",
        "Stale or observation-only; no fresh policy-event snapshot is configured.",
        "News/catalyst readiness registry",
        "Macro and policy catalyst copy must stay stale or missing until a durable event snapshot exists.",
        status="degraded",
    ),
    _spec(
