    ...
    sorted(
        (
            ...
            OfficialMacroSourceContract(
                ...
                source_type=_SOURCE_TYPE_OFFICIAL_PUBLIC,
                cadence="business_daily",
                expected_freshness_window="Expect one official trade-weighted U.S. dollar index publication per US business day after the FRED release posts.",
                ...
                notes=_notes(
                    "Official USD pressure score-grade candidate only when the DTWEXBGS trade-weighted dollar row is fresh and official.",
