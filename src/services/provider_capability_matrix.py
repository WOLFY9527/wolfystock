...
def _diagnostic_gap_fit_entry(
    ...
    *,
    ...
    return _provider_fit_entry(
        ...
        cache_required=cache_required,
        background_refresh_recommended=background_refresh_recommended,
        best_use_cases=(surface, *best_use_cases),
        rejected_for=rejected_for,
        not_recommended_for=not_recommended_for,
        missing_provider_reason=missing_provider_reason,
        plan_dependent=plan_dependent,
...
_PROVIDER_FIT_METADATA = (
    _diagnostic_gap_fit_entry(
        "portfolio.price_provenance",
        "Portfolio Price Provenance",
        provider_category="portfolio_diagnostic_gap",
        source_tier="cache_snapshot",
        trust_level="score_grade_when_stored_snapshot_qualified",
        freshness_expectation="stored_snapshot_with_lineage_freshness_and_non_fallback_price_evidence",
        surface="portfolio",
        paid_data_likely_required=False,
        key_required=False,
        cache_required=True,
        background_refresh_recommended=True,
        best_use_cases=("stored_snapshot_lineage_check", "portfolio_price_observation"),
        rejected_for=("runtime_price_mutation", "score_inputs_until_snapshot_qualified"),
        not_recommended_for=("live_quotes", "fallback_promotion"),
    ),
    _diagnostic_gap_fit_entry(
        "portfolio.fx_provenance",
        "Portfolio FX Provenance",
        provider_category="portfolio_diagnostic_gap",
        source_tier="cache_snapshot",
        trust_level="score_grade_when_stored_snapshot_qualified",
        freshness_expectation="stored_snapshot_with_lineage_freshness_and_non_fallback_fx_evidence",
        surface="portfolio",
        paid_data_likely_required=False,
        key_required=False,
        cache_required=True,
        background_refresh_recommended=True,
        best_use_cases=("stored_snapshot_lineage_check", "portfolio_fx_observation"),
        rejected_for=("runtime_fx_mutation", "score_inputs_until_snapshot_qualified"),
        not_recommended_for=("live_fx_claims", "fallback_promotion"),
    ),
    _diagnostic_gap_fit_entry(
        "portfolio.sector_industry_exposure",
        "Portfolio Sector / Industry Exposure",
        provider_category="portfolio_diagnostic_gap",
        source_tier="cache_snapshot",
        trust_level="score_grade_when_stored_snapshot_qualified",
        freshness_expectation="stored_snapshot_with_sector_industry_lineage_and_non_fallback_mappings",
        surface="portfolio",
        paid_data_likely_required=False,
        key_required=False,
        cache_required=True,
        background_refresh_recommended=True,
        best_use_cases=("sector_industry_mapping_observation", "portfolio_snapshot_lineage_check"),
        rejected_for=("taxonomy_runtime_mutation", "score_inputs_until_snapshot_qualified"),
        not_recommended_for=("live_sector_claims", "fallback_promotion"),
    ),
    _diagnostic_gap_fit_entry(
        "portfolio.factor_risk_metrics",
        "Portfolio Factor Risk Metrics",
        provider_category="portfolio_diagnostic_gap",
        source_tier="cache_snapshot",
        trust_level="score_grade_when_stored_snapshot_qualified",
        freshness_expectation="stored_snapshot_with_factor_lineage_freshness_and_non_fallback_inputs",
        surface="portfolio",
        paid_data_likely_required=False,
        key_required=False,
        cache_required=True,
        background_refresh_recommended=True,
        best_use_cases=("factor_risk_observation", "portfolio_snapshot_lineage_check"),
        rejected_for=("factor_runtime_mutation", "score_inputs_until_snapshot_qualified"),
        not_recommended_for=("live_factor_claims", "fallback_promotion"),
    ),
    _diagnostic_gap_fit_entry(
        "portfolio.benchmark_return_history",
        "Portfolio Benchmark Return History",
        provider_category="portfolio_diagnostic_gap",
        source_tier="cache_snapshot",
        trust_level="score_grade_when_stored_snapshot_qualified",
        freshness_expectation="stored_snapshot_with_benchmark_lineage_freshness_and_non_fallback_history",
        surface="portfolio",
        paid_data_likely_required=False,
        key_required=False,
        cache_required=True,
        background_refresh_recommended=True,
        best_use_cases=("benchmark_history_observation", "portfolio_snapshot_lineage_check"),
        rejected_for=("benchmark_runtime_mutation", "score_inputs_until_snapshot_qualified"),
        not_recommended_for=("live_benchmark_claims", "fallback_promotion"),
    ),
    _diagnostic_gap_fit_entry(
        "watchlist.scanner_score_snapshot",
        "Watchlist Scanner Score Snapshot",
        provider_category="watchlist_diagnostic_gap",
        source_tier="cache_snapshot",
        trust_level="observation_only",
        freshness_expectation="persisted_watchlist_snapshot_with_explicit_scanner_score_context",
        surface="watchlist",
        paid_data_likely_required=False,
        key_required=False,
        cache_required=True,
        background_refresh_recommended=True,
        best_use_cases=("watchlist_snapshot_observation", "scanner_score_persistence_audit"),
        rejected_for=("score_grade_claims", "silent_scanner_only_folding"),
        not_recommended_for=("watchlist_ranking_promotion", "live_scoring_claims"),
    ),
    _diagnostic_gap_fit_entry(
        "watchlist.score_refresh_freshness",
        "Watchlist Score Refresh Freshness",
        provider_category="watchlist_diagnostic_gap",
        source_tier="cache_snapshot",
        trust_level="observation_only",
        freshness_expectation="persisted_watchlist_refresh_window_and_freshness_audit",
        surface="watchlist",
        paid_data_likely_required=False,
        key_required=False,
        cache_required=True,
        background_refresh_recommended=True,
        best_use_cases=("watchlist_freshness_observation", "refresh_window_audit"),
        rejected_for=("score_grade_claims", "silent_scanner_only_folding"),
        not_recommended_for=("watchlist_ranking_promotion", "live_scoring_claims"),
    ),
    _diagnostic_gap_fit_entry(
        "watchlist.no_score_stale_state",
        "Watchlist No-score Stale State",
        provider_category="watchlist_diagnostic_gap",
        source_tier="cache_snapshot",
        trust_level="observation_only",
        freshness_expectation="watchlist_missing_or_stale_score_gap_projection",
        surface="watchlist",
        paid_data_likely_required=False,
        key_required=False,
        cache_required=True,
        background_refresh_recommended=True,
        best_use_cases=("watchlist_stale_gap_observation", "no_score_projection"),
        rejected_for=("score_grade_claims", "silent_scanner_only_folding"),
        not_recommended_for=("watchlist_ranking_promotion", "live_scoring_claims"),
        missing_provider_reason="watchlist_score_snapshot_not_persisted_or_stale",
    ),
    _diagnostic_gap_fit_entry(
        "watchlist.source_confidence_preservation",
        "Watchlist Source Confidence Preservation",
        provider_category="watchlist_diagnostic_gap",
        source_tier="cache_snapshot",
        trust_level="observation_only",
        freshness_expectation="persisted_watchlist_source_confidence_and_cap_reason_preservation",
        surface="watchlist",
        paid_data_likely_required=False,
        key_required=False,
        cache_required=True,
        background_refresh_recommended=True,
        best_use_cases=("watchlist_source_confidence_observation", "cap_reason_preservation"),
        rejected_for=("score_grade_claims", "silent_scanner_only_folding"),
        not_recommended_for=("watchlist_ranking_promotion", "live_scoring_claims"),
    ),
    _diagnostic_gap_fit_entry(
        "options_lab.synthetic_fixture_chain",
        "Options Lab Synthetic Fixture Chain",
        provider_category="options_lab_diagnostic_gap",
        source_tier="synthetic_fixture",
        trust_level="observation_only",
        freshness_expectation="synthetic_fixture_and_dry_run_chain_only",
        surface="options_lab",
        paid_data_likely_required=False,
        key_required=False,
        cache_required=True,
        background_refresh_recommended=False,
        best_use_cases=("synthetic_fixture_diagnostic", "dry_run_chain_audit"),
        rejected_for=("decision_grade_claims", "live_provider_promotion"),
        not_recommended_for=("trade_ranking", "live_chain_claims"),
    ),
    _diagnostic_gap_fit_entry(
        "options_lab.disabled_live_provider_stubs",
        "Options Lab Disabled Live Provider Stubs",
        provider_category="options_lab_diagnostic_gap",
        source_tier="disabled_live_stub",
        trust_level="observation_only",
        freshness_expectation="disabled_live_stub_diagnostic_only",
        surface="options_lab",
        paid_data_likely_required=False,
        key_required=False,
        cache_required=False,
        background_refresh_recommended=False,
        best_use_cases=("disabled_live_stub_audit", "dry_run_chain_audit"),
        rejected_for=("decision_grade_claims", "live_provider_promotion"),
        not_recommended_for=("trade_ranking", "live_chain_claims"),
    ),
    _diagnostic_gap_fit_entry(
        "options_lab.bid_ask_liquidity_gate",
        "Options Lab Bid/Ask Liquidity Gate",
        provider_category="options_lab_diagnostic_gap",
        source_tier="authorized_licensed_feed",
        trust_level="score_grade_when_authorized_chain_qualified",
        freshness_expectation="authorized_or_cached_option_chain_with_bid_ask_and_freshness_evidence",
        surface="options_lab",
        paid_data_likely_required=True,
        key_required=True,
        cache_required=True,
        background_refresh_recommended=True,
        best_use_cases=("options_bid_ask_gate_audit", "authorized_chain_requirements"),
        rejected_for=("decision_grade_claims_until_authorized_chain", "synthetic_promotion"),
        not_recommended_for=("fixture_only_ranking", "live_ordering_claims"),
        missing_provider_reason="options_lab_bid_ask_liquidity_chain_not_configured",
        plan_dependent=True,
    ),
    _diagnostic_gap_fit_entry(
        "options_lab.oi_volume_gate",
        "Options Lab OI / Volume Gate",
        provider_category="options_lab_diagnostic_gap",
        source_tier="authorized_licensed_feed",
        trust_level="score_grade_when_authorized_chain_qualified",
        freshness_expectation="authorized_or_cached_option_chain_with_oi_volume_and_freshness_evidence",
        surface="options_lab",
        paid_data_likely_required=True,
        key_required=True,
        cache_required=True,
        background_refresh_recommended=True,
        best_use_cases=("options_oi_volume_gate_audit", "authorized_chain_requirements"),
        rejected_for=("decision_grade_claims_until_authorized_chain", "synthetic_promotion"),
        not_recommended_for=("fixture_only_ranking", "live_ordering_claims"),
        missing_provider_reason="options_lab_oi_volume_chain_not_configured",
        plan_dependent=True,
    ),
    _diagnostic_gap_fit_entry(
        "options_lab.iv_greeks_gate",
        "Options Lab IV / Greeks Gate",
        provider_category="options_lab_diagnostic_gap",
        source_tier="authorized_licensed_feed",
        trust_level="score_grade_when_authorized_chain_qualified",
        freshness_expectation="authorized_or_cached_option_chain_with_iv_greeks_and_freshness_evidence",
        surface="options_lab",
        paid_data_likely_required=True,
        key_required=True,
        cache_required=True,
        background_refresh_recommended=True,
        best_use_cases=("options_iv_greeks_gate_audit", "authorized_chain_requirements"),
        rejected_for=("decision_grade_claims_until_authorized_chain", "synthetic_promotion"),
        not_recommended_for=("fixture_only_ranking", "live_ordering_claims"),
        missing_provider_reason="options_lab_iv_greeks_chain_not_configured",
        plan_dependent=True,
    ),
    _diagnostic_gap_fit_entry(
        "options_lab.iv_rank_history",
        "Options Lab IV Rank History",
        provider_category="options_lab_diagnostic_gap",
        source_tier="authorized_licensed_feed",
        trust_level="score_grade_when_authorized_chain_qualified",
        freshness_expectation="authorized_or_cached_option_chain_with_iv_rank_history_and_freshness_evidence",
        surface="options_lab",
        paid_data_likely_required=True,
        key_required=True,
        cache_required=True,
        background_refresh_recommended=True,
        best_use_cases=("options_iv_rank_history_audit", "authorized_chain_requirements"),
        rejected_for=("decision_grade_claims_until_authorized_chain", "synthetic_promotion"),
        not_recommended_for=("fixture_only_ranking", "live_ordering_claims"),
        missing_provider_reason="options_lab_iv_rank_history_chain_not_configured",
        plan_dependent=True,
    ),
    _provider_fit_entry(
