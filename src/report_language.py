...
_OPERATION_ADVICE_TRANSLATIONS = {
    "strong_buy": {"zh": "正向观察", "en": "Positive observation"},
    "buy": {"zh": "正向观察", "en": "Positive observation"},
    "hold": {"zh": "继续跟踪", "en": "Continue observing"},
    "watch": {"zh": "观望", "en": "Watch"},
    "reduce": {"zh": "风险收缩", "en": "Risk contraction"},
    "sell": {"zh": "风险收缩", "en": "Risk contraction"},
    "strong_sell": {"zh": "风险收缩", "en": "Risk contraction"},
}
...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "one_sentence_label": "一句话观察",
        "time_sensitivity_label": "时效性",
        "default_time_sensitivity": "本周内",
        "position_status_label": "暴露状态",
        "action_advice_label": "研究状态",
        "no_position_label": "未持有状态",
        "has_position_label": "已持有状态",
        ...
        "ideal_buy_label": "关键价位参考",
        "secondary_buy_label": "参考区间",
        "stop_loss_label": "风险边界",
        "take_profit_label": "收益阈值",
        "suggested_position_label": "暴露变化参考",
        "entry_plan_label": "观察触发",
        "risk_control_label": "观察解除",
        ...
        "no_results": "无分析结果",
        "report_title": "股票研究观察报告",
        "avg_score_label": "均分",
        "action_points_heading": "关键价位参考",
        "position_advice_heading": "情景观察",
        "analysis_model_label": "分析模型",
        "not_investment_advice": "仅供研究观察，不构成投资建议",
    ...
    "en": {
        ...
        "buy_label": "Positive observation",
        "watch_label": "Watch",
        "sell_label": "Risk contraction",
        ...
        "one_sentence_label": "One-line Observation",
        "time_sensitivity_label": "Time Sensitivity",
        "default_time_sensitivity": "This week",
        "position_status_label": "Exposure State",
        "action_advice_label": "Research State",
        "no_position_label": "No Exposure",
        "has_position_label": "Existing Exposure",
        "continue_holding": "Continue observing",
        ...
        "ideal_buy_label": "Key Price Reference",
        "secondary_buy_label": "Reference Range",
        "stop_loss_label": "Risk Boundary",
        "take_profit_label": "Return Threshold",
        "suggested_position_label": "Exposure Reference",
        "entry_plan_label": "Observation Trigger",
        "risk_control_label": "Observation Release",
        "checklist_heading": "Checklist",
        "failed_checks_heading": "Failed Checks",
        "history_compare_heading": "Historical Signal Comparison",
        "time_label": "Time",
        "score_label": "Score",
        "advice_label": "Research State",
        "trend_label": "Trend",
        "generated_at_label": "Generated At",
        "report_time_label": "Generated",
        "no_results": "No analysis results",
        "report_title": "Stock Research Observation Report",
        "avg_score_label": "Avg Score",
        "action_points_heading": "Key Price References",
        "position_advice_heading": "Scenario Observation",
        "analysis_model_label": "Model",
        "not_investment_advice": "For research observation only. Not investment advice.",
