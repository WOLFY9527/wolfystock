...
summary = {
    ...
    "completedFoundationEvidence": [
        ...
        },
        {
            ...
            "blockerId": "api_abuse_request_safety",
            ...
            "releaseApproved": False,
            "evidence": [
                "request-safety regression anchors stay repo-local and offline only",
                "accepted launch artifact still required before this hard blocker can clear",
                "no approval semantics granted and no accepted launch evidence implied",
            ],
        },
        {
            "id": "admin_log_retention_capacity_rehearsal_completed_foundation_evidence",
            "blockerId": "admin_log_retention_capacity_rehearsal",
            "status": "completed_foundation_evidence_only",
            "foundationStatus": "completed",
            "evidenceScope": "repo_local_offline_only",
            "acceptedLaunchArtifactRequired": True,
            ...
            "releaseApproved": False,
            "evidence": [
                "retention/capacity rehearsal anchors stay repo-local and offline only",
                "accepted launch artifact still required before this hard blocker can clear",
                "no approval semantics granted and no accepted launch evidence implied",
            ],
        },
        {
            "id": "market_data_freshness_fallback_evidence_completed_foundation_evidence",
            "blockerId": "market_data_freshness_fallback_evidence",
            "status": "completed_foundation_evidence_only",
            "foundationStatus": "completed",
            "evidenceScope": "repo_local_offline_only",
            "acceptedLaunchArtifactRequired": True,
            ...
            "releaseApproved": False,
            "evidence": [
                "freshness/fallback disclosure anchors stay repo-local and offline only",
                "accepted launch artifact still required before this hard blocker can clear",
                "no approval semantics granted and no accepted launch evidence implied",
            ],
        },
