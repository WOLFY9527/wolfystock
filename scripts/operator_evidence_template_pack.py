...
def _ws2_target_environment_template() -> dict[str, Any]:
    return {
        ...
        "targetEnvironmentLabel": "staging-environment-label",
        "deploymentTopologyLabel": "api-a-api-b-worker-durable-polling",
        "runId": "ws2-target-evidence-run-0001",
        "operator": "sanitized-operator-label",
        "capturedAt": TEMPLATE_TIMESTAMP,
        "submittedAt": TEMPLATE_TIMESTAMP,
        "completedAt": TEMPLATE_TIMESTAMP,
        "reviewerAcceptanceStatus": "needs-review",
        "reviewerLabel": "review-ticket-label",
        "releaseApproved": False,
        "publicLaunchReady": False,
        ...
        "topology": {
            ...
            "storageLabel": "target-durable-storage",
        ...
        "checks": {
            "apiASubmitTransportExercised": False,
            "syntheticWorkerLeaseFlowVerified": False,
            "workerLeaseAcquired": False,
            "progressPersisted": False,
            "apiBDurableStatusReadback": False,
            "apiBPollingReplayVerified": False,
            "apiBDurablePollingReadback": False,
            "ownerHiddenStatusVerified": False,
            "ownerHiddenPollingVerified": False,
            "retryFailureSafetyVerified": False,
            "leaseExpiryRecoveryVerified": False,
            "staleWorkerWriteRejected": False,
            "retryCapVerified": False,
            "terminalFailurePollable": False,
            "ownerIsolationVerified": False,
            "sanitizedFailureOutputVerified": False,
            "sseLimitationRecorded": True,
            "crossInstanceSseNotClaimed": True,
            "durablePollingBaselineRecorded": True,
        },
        "summaries": {
            "apiASubmitTransport": "Awaiting operator-filled API A submit evidence.",
            "workerLease": "Awaiting operator-filled worker lease evidence.",
            "progressPersistence": "Awaiting operator-filled durable progress evidence.",
            "apiBDurableStatusReadback": "Awaiting operator-filled API B durable status readback evidence.",
            "apiBPollingReplay": "Awaiting operator-filled API B after-sequence polling replay evidence.",
            "apiBDurablePolling": "Awaiting operator-filled API B polling evidence.",
            "ownerHiddenStatus": "Awaiting operator-filled cross-owner status hidden-not-found evidence.",
            "ownerHiddenPolling": "Awaiting operator-filled cross-owner polling hidden-not-found evidence.",
            "retryFailureSafety": "Awaiting operator-filled retry and failure safety evidence.",
            "leaseExpiryRecovery": "Awaiting operator-filled lease expiry recovery evidence.",
            "staleWorkerWriteRejection": "Awaiting operator-filled stale-worker terminal write rejection evidence.",
            "ownerIsolation": "Awaiting operator-filled owner isolation evidence.",
            "sanitizedFailureOutput": "Awaiting operator-filled sanitized failure evidence.",
            "sseLimitation": "Process-local SSE limitation remains recorded; durable polling is the baseline.",
            "reviewNotes": "Template only; replace placeholders with sanitized target-run summaries before review.",
        },
        "manualReview": {
            "manualReviewRequired": True,
            "manualReviewStatus": "needs-review",
            "singleInstanceExceptionPosture": "needs-review",
            "rollbackOrDegradedNote": "Awaiting operator-filled rollback or degraded-topology note.",
        },
        "templatePlaceholders": _template_placeholders(),
    }
...
def _config_snapshot_template() -> dict[str, Any]:
    return {
        ...
        "postureEvidence": {
            "targetEnvironmentLabel": "staging-environment-label",
            "productionMode": "needs-review",
            "authEnabled": "needs-review",
            "corsPosture": "needs-review",
            "csrfPosture": "needs-review",
            "trustedProxyPosture": "needs-review",
            "mfaEnforcementScope": "needs-review",
            "rbacFallbackPosture": "needs-review",
            "quotaMode": "needs-review",
            "backupPitrOptIn": "needs-review",
            "stagingIngressOptIn": "needs-review",
            "publicSearxngInstancePosture": "needs-review",
            "cryptoRealtimeDecisionPosture": "needs-review",
            "providerCredentialPresenceStates": {
                "llmProvider": "needs-review",
                "marketDataProvider": "needs-review",
                "optionsLiveProvider": "needs-review",
            },
        },
        "manualReview": {
            "status": "needs-review",
...
TEMPLATE_SPECS: tuple[TemplateSpec, ...] = (
    ...
    TemplateSpec(
        ...
        _ws2_target_environment_template,
    ),
