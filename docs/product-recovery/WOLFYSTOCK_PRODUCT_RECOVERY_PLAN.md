...
- `docs/archive/product-audit/qw003-screenshot-ux-qa-pass.md` concluded that
...
- `docs/archive/product-audit/qw006-consumer-internal-wording-sweep.md` found
  ...
  surfaces.
- `docs/archive/product-recovery/PR003A_CORE_DATA_REALITY_PATH_ROOT_CAUSE.md`
