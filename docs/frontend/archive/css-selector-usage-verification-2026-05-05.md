...
| `home-panel-card` | `src/index.css:2904-2910`; theme override `4212`; SpaceX override `10821`. Report/Home panel modifier. | Historical legacy report components. | Historical evidence | Medium | Re-verify current owners before any selector deletion. |
| `home-subpanel` | `src/index.css:2973-2988`; theme overrides `4131` and `4139`. Home/report nested panel. | Historical legacy report news component. | Historical evidence | Medium | Re-verify current owners before any selector deletion. |
