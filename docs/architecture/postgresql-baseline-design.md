...
- Evidence:
  ...
  - `docs/archive/architecture/multi-user-foundation/multi-user-foundation-phase2.md`
...
- Evidence:
  ...
  - `src/storage.py`
  - `docs/archive/architecture/multi-user-foundation/multi-user-foundation-phase3.md`
- Storage inconsistencies:
