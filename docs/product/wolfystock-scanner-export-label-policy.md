...
- `docs/audits/wolfystock-chinese-form-label-review.md`: classifies Scanner CSV headers and generated filenames as P3 export artifacts requiring a product decision before implementation.
