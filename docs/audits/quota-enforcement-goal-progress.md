# Quota Advisory Reserve/Release Pilot

Date: 2026-06-11
Status: advisory-only, disabled by default

This note records the current route-local quota pilot boundary. It is not
public-launch approval, not live quota enforcement, not a billing-authority
statement, not consume wiring, and not route blocking.
...
Only these pilot controls are part of this boundary:
...
This boundary intentionally does not pass reservation identity into
