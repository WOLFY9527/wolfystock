...
| Live quota enforcement | A default-off, owner-allowlisted sync single-stock analysis route pilot exists, but accepted operator/staging evidence and broad spend-cap readiness remain incomplete. | Cost ledger, quota helper surfaces, and a narrow rollback-switchable route pilot exist. | Attach accepted sanitized evidence for the narrow pilot, then separately design broader quota expansion and status visibility. | P0 | Cost / Quota |
