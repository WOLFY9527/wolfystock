...
- WolfyStock Reflect-Linear style, aligned with `docs/frontend/visual-system.md` and existing admin pages such as `AdminLogsPage.tsx` and `MarketProviderOperationsPage.tsx`.
