...
| Backtest | [Backtest Docs](./backtest/README.md) | [Backtest System](./backtest-system.md), [Backtest helper maintenance](./backtest-helper-maintenance.md), [Transaction cost and slippage readiness](./backtest/transaction-cost-slippage-readiness.md), [Rule backtest reopen trust status](./architecture/rule-backtest-reopen-trustworthiness-p0-status-index-2026-04-22.md) |
