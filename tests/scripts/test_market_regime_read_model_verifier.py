...
from scripts.market_regime_read_model_verifier import main
...
def test_cli_outputs_market_regime_read_model_from_explicit_local_paths(tmp_path: Path, capsys) -> None:
    ...
    assert payload["evidenceCards"][0]["consumerSafe"] is True
