...
def test_disabled_default_import_does_not_import_redis_or_valkey() -> None:
            ...
            json.dumps(
                {
                    ...
                    "backend_type": type(market_cache_module.market_cache._remote_backend).__name__,
    ...
    assert result["config_backend"] == "disabled"


def test_env_set_before_first_import_deterministically_builds_module_singleton() -> None:
    result = _run_market_cache_subprocess(
        """
        import json
        import sys
        ...
        remote_backend = market_cache_module.market_cache._remote_backend
        print(
            json.dumps(
                {
                    "config_backend": get_config().market_cache_remote_backend,
...
def test_env_changes_after_import_do_not_silently_rebuild_singleton() -> None:
    result = _run_market_cache_subprocess(
        ...
        before_cache = market_cache_module.market_cache
        ...
        after_cache = market_cache_module.market_cache
