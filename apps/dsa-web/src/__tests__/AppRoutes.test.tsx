...
describe('AppContent route flows', () => {
  ...
  it.each([
    ...
    ['/admin/provider-operations', '/admin/market-providers', { ...noCapabilities, canReadProviders: true }, 'market-provider-operations-page'],
    ...
    ['/zh/admin/provider-operations', '/zh/admin/market-providers', { ...noCapabilities, canReadProviders: true }, 'market-provider-operations-page'],
    ...
    ['/en/admin/provider-operations', '/en/admin/market-providers', { ...noCapabilities, canReadProviders: true }, 'market-provider-operations-page'],
  ...
  it.each([
    ...
    ['/zh/admin/provider-operations', '/zh/admin/market-providers', '需要管理员登录', '/zh/login?redirect=%2Fzh%2Fadmin%2Fmarket-providers'],
    ...
    ['/en/admin/provider-operations', '/en/admin/market-providers', 'Admin Sign-in Required', '/en/login?redirect=%2Fen%2Fadmin%2Fmarket-providers'],
  ...
  it.each([
    ...
    ['/admin/provider-operations', '/admin/market-providers', 'Admin Sign-in Required', '/login?redirect=%2Fadmin%2Fmarket-providers'],
  ...
  it('renders the localized market rotation radar route', async () => {
    ...
    expect(within(marketMenu).getByRole('link', { name: '市场总览' })).toHaveAttribute('href', '/zh/market-overview');
    expect(within(marketMenu).getByRole('link', { name: '板块轮动' })).toHaveAttribute('href', '/zh/market/rotation-radar');
    expect(within(marketMenu).getByRole('link', { name: '板块轮动' })).toHaveClass('is-active');
  });
  ...
  it('renders the localized liquidity monitor route', async () => {
    ...
    const marketMenu = await screen.findByTestId('shell-nav-group-menu-market');
    expect(within(marketMenu).getByRole('link', { name: '市场总览' })).toHaveAttribute('href', '/zh/market-overview');
    expect(within(marketMenu).getByRole('link', { name: '流动性监测' })).toHaveAttribute('href', '/zh/market/liquidity-monitor');
    expect(within(marketMenu).getByRole('link', { name: '流动性监测' })).toHaveClass('is-active');
  });
