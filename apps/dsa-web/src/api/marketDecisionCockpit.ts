...
function normalizeCockpitResponse(payload: unknown): MarketDecisionCockpitResponse {
  ...
  return {
    ...
    researchQueuePreview: {
      ...
      previewOnly: normalized.researchQueuePreview?.previewOnly,
    ...
    optionsStructureStatus: {
      ...
      observationOnly: normalized.optionsStructureStatus?.observationOnly,
      decisionGrade: normalized.optionsStructureStatus?.decisionGrade,
    ...
    dataQuality: normalized.dataQuality ? {
      ...
      asOf: normalized.dataQuality.asOf,
      blockingModules: normalized.dataQuality.blockingModules,
      operatorAction: normalized.dataQuality.operatorAction,
      consumerSafeMessage: normalized.dataQuality.consumerSafeMessage,
