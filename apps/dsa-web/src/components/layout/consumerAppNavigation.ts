...
const ROUTE_STORIES: ConsumerRouteStory[] = [
  {
    routeKey: 'home',
    group: 'start',
    ...
    copy: {
      zh: {
        ...
        boundary: '当前内容只用于研究观察，不构成买卖或执行建议。',
      ...
      en: {
        ...
        nextStep: 'Use Market Overview for context, or sign in and run Scanner to build a watch queue.',
        evidence: 'Evidence boundary: summaries, charts, and reports expose coverage status.',
        boundary: 'Content is for research observation only, not buy, sell, or execution guidance.',
        primaryAction: 'Open Market Overview',
        secondaryAction: 'View Scanner',
      },
    },
  },
  {
    ...
    copy: {
      ...
      en: {
        ...
        boundary: 'This is a market observation view and does not produce execution actions.',
  ...
  },
  {
    ...
    copy: {
      zh: {
        ...
        boundary: '页面只呈现流动性观察，不扩展为仓位或交易指令。',
      ...
      en: {
        ...
        boundary: 'This page shows liquidity observation only, not allocation or execution instructions.',
  ...
  },
  {
    ...
    copy: {
      zh: {
        ...
        nextStep: '确认主题后，登录运行扫描器生成可复核候选。',
        evidence: '证据边界：只展示当前可解释的主题支持与限制。',
        boundary: '轮动状态仅用于研究排序，不形成交易建议。',
        primaryAction: '运行扫描器',
        secondaryAction: '返回市场总览',
      },
      en: {
        ...
        nextStep: 'After confirming a theme, sign in and run Scanner for reviewable candidates.',
        evidence: 'Evidence boundary: only explainable theme support and limits are shown.',
        boundary: 'Rotation states are for research ranking only, not trading advice.',
        primaryAction: 'Run Scanner',
        secondaryAction: 'Back to Overview',
      },
    },
  },
  {
    ...
    copy: {
      zh: {
        ...
        nextStep: '运行后把候选加入观察列表，再进入组合或回测验证。',
        evidence: '证据边界：候选解释、运行事实和空结果原因会保持可见。',
        boundary: '候选只代表研究入口，不代表买入、卖出或执行安排。',
      ...
      en: {
        ...
        nextStep: 'After a run, move candidates to Watchlist before portfolio or backtest review.',
        evidence: 'Evidence boundary: candidate rationale, run facts, and empty reasons stay visible.',
        boundary: 'Candidates are research entry points, not buy, sell, or execution arrangements.',
  ...
  },
  {
    ...
    copy: {
      zh: {
        ...
        purpose: '观察列表用于跟踪候选状态、提醒和下一步研究动作。',
        nextStep: '有持仓关联时进入组合总览；需要新候选时返回扫描器。',
        evidence: '证据边界：提醒、状态和数据说明会与列表同屏展示。',
        boundary: '观察列表不是交易清单，也不自动触发外部通知或委托。',
        primaryAction: '打开组合',
      ...
      en: {
        ...
        purpose: 'Watchlist tracks candidate state, alerts, and follow-up research actions.',
        nextStep: 'Open Portfolio when holdings matter; return to Scanner when you need new candidates.',
        evidence: 'Evidence boundary: alerts, state, and data notes stay near the list.',
        boundary: 'Watchlist is not an order list and does not trigger external notifications or orders by itself.',
  ...
  },
  {
    ...
    copy: {
      zh: {
        ...
        nextStep: '回到观察列表复核候选，或用回测验证规则假设。',
        evidence: '证据边界：估值、外汇和风险置信度会展示可用状态。',
        boundary: '这里不连接真实委托，也不新增交易执行路径。',
        primaryAction: '打开观察列表',
      ...
      en: {
        ...
        nextStep: 'Return to Watchlist for candidate review, or use Backtest to validate rule assumptions.',
        evidence: 'Evidence boundary: valuation, FX, and risk confidence expose availability states.',
        boundary: 'This does not connect live orders or add an execution path.',
        primaryAction: 'Open Watchlist',
  ...
  },
  {
    ...
    copy: {
      ...
      en: {
        ...
        boundary: 'Backtest output does not change backend trading, broker, or order behavior.',
  ...
  },
  {
    ...
    copy: {
      zh: {
        eyebrow: '验证 / 期权',
        title: '只读比较期权情景，不把样例变成执行建议。',
        purpose: '期权实验室用于整理假设价格、到期日、风险预算与样例结构。',
        nextStep: '先用回测复核标的假设，再回到市场总览确认背景。',
        evidence: '证据边界：可用性、链数据和情景估算会标明限制。',
        boundary: '页面不创建订单、不解锁交易，也不输出执行指令。',
        primaryAction: '打开回测',
        secondaryAction: '回到市场总览',
      },
      en: {
        eyebrow: 'Validate / Options',
        title: 'Compare read-only option scenarios without turning samples into execution advice.',
        ...
        boundary: 'The page creates no orders, unlocks no trading, and emits no execution instruction.',
