...
export function WolfyShellSurface({
  ...
  return (
    <Component
      ...
      className={cn(
        'min-w-0 rounded-xl shadow-none',
...
export function ResearchConsoleShell({
  ...
  return (
    <div
      ...
      className={cn(
        'relative isolate flex w-full min-w-0 flex-col gap-3 overflow-hidden rounded-2xl border border-[color:var(--wolfy-border-subtle)] bg-[var(--wolfy-surface-console)] p-2.5 shadow-[var(--wolfy-shadow-console)] md:p-3',
        className,
      )}
      {...props}
    >
      ...
      <div
        className={cn(
          'grid min-w-0 overflow-hidden rounded-xl border border-[color:var(--wolfy-divider)] bg-[var(--wolfy-surface-console)]',
