...
describe('BacktestResultReport', () => {
  it('renders the same core sections for simple and professional modes', () => {
    ...
    expect(within(tradeTable).getByText('回测交易与成本账本')).toHaveClass('sr-only');
    ...
    const compositionOrder = screen.getByTestId('backtest-result-composition-order');
    expect(compositionOrder).toHaveTextContent('收益曲线与基准');
    expect(compositionOrder).toHaveTextContent('回撤');
