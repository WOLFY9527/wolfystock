...
const enCopy: typeof zhCopy = {
  ...
  targetGroup: 'Scenario observation',
  optionalGroup: 'Optional ETF observation marks',
  ...
  underlyingTarget: 'Underlying scenario upper line',
  etfTarget: 'ETF scenario upper line',
  etfEntry: 'ETF observation band',
  etfStop: 'ETF risk boundary',
  etfTakeProfit: 'ETF volatility upper line',
  forwardTitle: 'ETF linear estimate',
  reverseTitle: 'Implied underlying',
  marksTitle: 'Observation marks',
  missingTargets: 'Enter reference prices and at least one observation level to show a linear mapping.',
  ...
  formulaHint: 'ETF estimate = ETF reference x (1 + leverage x (underlying scenario / underlying reference - 1))',
