...
const PHRASE_LABELS: Record<string, Record<ConsumerStatusLocale, string>> = {
  ...
  'missing evidence needs review': { zh: '当前条目的证据覆盖不足，需补充同业、基本面或市场背景后再判断。', en: 'Evidence coverage is incomplete. Add peer, fundamental, or market context before judging.' },
  'evidence needs refresh': { zh: '现有证据时效不足，建议先复核近期价格、同业与市场背景。', en: 'Current evidence needs a freshness review before going further.' },
  'price-history evidence': { zh: '价格历史数据待补充', en: 'Price-history evidence still missing' },
  'supporting evidence': { zh: '同业、基本面或市场背景待补充', en: 'Supporting peer, fundamental, or market context still missing' },
