...
const REPORT_HEADING_ZH_MAP: Record<string, string> = {
  decisionsummary: '研究摘要',
  executivesummary: '研究摘要',
  executionplan: '观察计划',
  executionlayer: '观察计划',
  currentaction: '当前观察',
  immediateactions: '当前观察',
  fornewpositions: '新观察策略',
  newpositionplan: '新观察策略',
  forexistingpositions: '既有观察策略',
...
const REPORT_HEADING_EN_MAP: Record<string, string> = {
  decisionsummary: 'Research summary',
  executivesummary: 'Research summary',
  executionplan: 'Observation plan',
  executionlayer: 'Observation plan',
  currentaction: 'Current observation',
  immediateactions: 'Current observation',
  fornewpositions: 'For new observations',
  newpositionplan: 'For new observations',
  ...
  appendix: 'Appendix',
  决策摘要: 'Research summary',
  执行计划: 'Observation plan',
  当前动作: 'Current observation',
  新开仓策略: 'For new observations',
  已持仓策略: 'For existing observations',
...
const CONTROLLED_VALUE_RULES: ControlledValueRule[] = [
  ...
  },
  {
    ...
    supportZh: '观察状态不变',
    supportEn: 'Observation state unchanged',
  },
  {
    aliases: ['回踩买点', '回调买点', '等待回踩确认后分批试仓', '优先等待回踩ma20一带出现承接再考虑分批试仓'],
    zh: '回踩观察区间',
    en: 'Pullback observation range',
    supportZh: '等待承接确认',
  ...
  },
  {
    aliases: ['分批试仓'],
    zh: '分段观察',
    en: 'Staged observation',
    supportZh: '分段记录暴露变化',
    supportEn: 'Track exposure in stages',
  },
  {
    aliases: ['等待回踩后分两笔建立底仓'],
    zh: '等待回踩后分段观察',
    en: 'Observe in stages after the pullback',
    supportZh: '回踩后再确认观察状态',
    supportEn: 'Wait for the pullback before changing observation state',
  },
  {
  ...
  },
  {
    ...
    zh: '放量跌破支撑位时观察暴露收缩信号',
    en: 'Watch exposure-reduction signal if support breaks on volume',
    supportZh: '跌破后观察暴露变化',
    supportEn: 'Watch exposure change on break',
  },
  {
  ...
  },
  {
    ...
    zh: '暴露收缩信号',
    en: 'Exposure-reduction signal',
    supportZh: '风险变化待观察',
    supportEn: 'Risk change to observe',
  },
  {
    aliases: ['增持', 'accumulate', 'add', 'addposition', '加仓', '顺势加仓', 'buildposition', 'build', '试仓', '开仓', '建仓'],
    zh: '暴露增加信号',
    en: 'Exposure-increase signal',
    supportZh: '顺势观察',
    supportEn: 'Observe strength',
  },
  {
    ...
    en: 'Positive signal',
    supportZh: '观察触发条件具备',
    supportEn: 'Observation trigger ready',
  },
  {
    ...
    en: 'Reverse signal',
    supportZh: '观察解除条件出现',
    supportEn: 'Observation release appeared',
  },
  {
