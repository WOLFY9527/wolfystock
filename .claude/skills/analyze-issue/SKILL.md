...
**Repository**: https://github.com/WOLFY9527/wolfystock/issues
...
```bash
gh issue view <issue_number> --repo WOLFY9527/wolfystock
gh issue view <issue_number> --repo WOLFY9527/wolfystock --comments
```
