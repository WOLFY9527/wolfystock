...
**Repository**: https://github.com/WOLFY9527/daily_stock_analysis/pulls
...
```bash
gh pr view <pr_number> --repo WOLFY9527/daily_stock_analysis
gh pr view <pr_number> --repo WOLFY9527/daily_stock_analysis --comments
gh pr checks <pr_number> --repo WOLFY9527/daily_stock_analysis
gh pr diff <pr_number> --repo WOLFY9527/daily_stock_analysis
```
