...
**Repository**: https://github.com/WOLFY9527/wolfystock/pulls
...
```bash
gh pr view <pr_number> --repo WOLFY9527/wolfystock
gh pr view <pr_number> --repo WOLFY9527/wolfystock --comments
gh pr checks <pr_number> --repo WOLFY9527/wolfystock
gh pr diff <pr_number> --repo WOLFY9527/wolfystock
```
