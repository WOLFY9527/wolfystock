...
- Follow `AGENTS.md`; read `docs/design/frontend.md` and
  `docs/contracts/data-trust.md` for frontend, no-advice, readiness, and
...
- Validate Web changes through `./wolfy exec --profile test --` and
  `scripts/web_build_artifact.py`. For visual changes, add route/browser evidence.
